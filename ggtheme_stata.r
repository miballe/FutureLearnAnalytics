...
theme_stata_base <- function(base_size = 11, base_family = "sans") {
  ...
  theme(line = element_line(size = 0.5, linetype = 1, lineend = "butt",
        ...
        axis.title = element_text(size = rel(relsz["medlarge"])),
        axis.title.x = element_text(margin = margin(5,0,0,0)),
        axis.title.y = element_text(angle = 90, vjust = 0, margin = margin(0,5,0,0)),
        ...
        plot.title = element_text(size = rel(relsz["huge"]),
                                  hjust = 0.5,
                                  vjust = 1),
